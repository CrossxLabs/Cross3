...
export default function Privacy() {
  return (
    <OpenLayout>
      <Header customClass="sm:px-4 pt-4" />
      <main className="w-11/12 py-16 m-auto">
        <Image
          ...
          draggable={false}
        />
        <article className="prose prose-invert prose-headings:text-stone-700 prose-strong:text-stone-800 prose-blockquote:text-stone-950 prose-p:text-stone-950 prose-span:text-stone-950 prose-ol:text-stone-950 prose-ul:text-stone-950 prose-li:text-stone-950 prose-a:text-theme-primary/70 max-w-none">
          <h1 className="font-righteous font-semibold mt-10 text-5xl max-sm:text-3xl">Privacy Policy</h1>
          <blockquote className="-mt-6 text-sm sm:text-base font-normal">Last Updated: September, 2024</blockquote>
          <h2>Your privacy is important to us</h2>
          <p>
            It is {title}'s policy to respect your privacy regarding any information we may collect while operating our
            website. This Privacy Policy applies to <Link href="/">vercel.com</Link> (hereinafter, "us", "we", or
            "vercel.com"). We respect your privacy and are committed to protecting personally identifiable information
          ...
          <p>
            ...
            leaving comments on <Link href="/">vercel.com</Link> blog posts. {title} only discloses logged in user and
          ...
          <p>
            ...
            <Link href="/"> vercel.com</Link> to provide a username and email address.
          </p>
          <h3>Security</h3>
          <p>
          ...
          <p>
            If you are a registered user of <Link href="/">vercel.com</Link> and have supplied your email address,
          ...
          <p>
            ...
            and track visitors, their usage of <Link href="/">vercel.com</Link> and their website access preferences.{' '}
          </p>
          <p>
          ...
          <p>
            ...
            <Link href="mailto:contact@cross3.me" className="ml-1">
              contact@cross3.me
            </Link>
            .
          </p>
