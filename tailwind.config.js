  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'create-gradient-004':
          'linear-gradient(135deg, #fc692a, #ffd800 26.04%, #72db5a 49.48%, #6dc4fe 75.52%, #cdb9fa)',

        'create-gradient-005': 'linear-gradient(90deg, #FF0079 0%, #592489 100%)',
        'create-gradient-006': 'linear-gradient(to right, #FF4B00 0%, #FFAB00 100%)',
